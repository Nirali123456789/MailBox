...
class SentRepository(private val sentDao: SentDao) {
    ...
    var arrayList: ArrayList<Sent> = arrayListOf()
...
//        }
    ...
    fun getSentList(): LiveData<List<Sent>> {
        return sentDao.getAllMail()
    }
